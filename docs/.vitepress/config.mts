...
export default defineConfig({
  ...
  vite: {
    plugins: [
      ...
      GitChangelog({
        // 填写在此处填写您的仓库链接
        repoURL: () => 'https://github.com/BeiKen77/wkwbk.github.io',
      }),
  ...
  themeConfig: {
    ...
    // 编辑本页
    editLink: {
      pattern: 'https://github.com/BeiKen77/wkwbk.github.io/edit/main/docs/:path',
      text: '在 GitHub 编辑本页'
    },
    ...
    // 社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/BeiKen77' },
      {
        icon: {
